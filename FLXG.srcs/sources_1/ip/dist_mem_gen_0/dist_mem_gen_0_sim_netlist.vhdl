...
--               d:/VivadoProject/FLXG/FLXG.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_sim_netlist.vhdl
...
entity dist_mem_gen_0_dist_mem_gen_v8_0_13 is
  ...
  attribute C_WIDTH of dist_mem_gen_0_dist_mem_gen_v8_0_13 : entity is 27;
  attribute ORIG_REF_NAME : string;
...
architecture STRUCTURE of dist_mem_gen_0_dist_mem_gen_v8_0_13 is
  ...
  signal \^spo\ : STD_LOGIC_VECTOR ( 18 downto 2 );
begin
  dpo(26) <= \<const0>\;
  dpo(25) <= \<const0>\;
  dpo(24) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.dist_mem_gen_0_dist_mem_gen_v8_0_13_synth
     port map (
      ...
      spo(7 downto 1) => \^spo\(10 downto 4),
      spo(0) => \^spo\(2)
    );
end STRUCTURE;
library IEEE;
